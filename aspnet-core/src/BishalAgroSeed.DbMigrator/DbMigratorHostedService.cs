...
public class DbMigratorHostedService : IHostedService
{
    ...
    {
        using (var application = await AbpApplicationFactory.CreateAsync<BishalAgroSeedDbMigratorModule>(options =>
        {
        ...
        }))
        {
            ...
            await application
                .ServiceProvider
                .GetRequiredService<BishalAgroSeedDbMigrationService>()
                .MigrateAsync();
