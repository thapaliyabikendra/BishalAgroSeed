...
public class BishalAgroSeedAuthServerModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<BishalAgroSeedDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}BishalAgroSeed.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<BishalAgroSeedDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}BishalAgroSeed.Domain"));
            });
        }
        ...
        {
            options.KeyPrefix = "BishalAgroSeed:";
        });
