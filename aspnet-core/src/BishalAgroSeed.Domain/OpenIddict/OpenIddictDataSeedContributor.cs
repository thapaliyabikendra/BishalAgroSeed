...
namespace BishalAgroSeed.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("BishalAgroSeed") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "BishalAgroSeed", DisplayName = "BishalAgroSeed API", Resources = { "BishalAgroSeed" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["BishalAgroSeed_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["BishalAgroSeed_Web:RootUrl"].EnsureEndsWith('/');

            /* BishalAgroSeed_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["BishalAgroSeed_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        var consoleAndAngularClientId = configurationSection["BishalAgroSeed_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["BishalAgroSeed_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        // Blazor Client
        var blazorClientId = configurationSection["BishalAgroSeed_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["BishalAgroSeed_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        var blazorServerTieredClientId = configurationSection["BishalAgroSeed_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl =
                configurationSection["BishalAgroSeed_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["BishalAgroSeed_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit
                },
